...
// Testing: writeFile / readFile / remove
{
  ...
  assertEquals(
    buffer,
    await Bueno.fs.readFile("async.bin"),
    "writeFile/readFile error",
  );
...
// Testing: writeFileSync / readFileSync / removeSync
{
  ...
  assertEquals(
    buffer,
    Bueno.fs.readFileSync("sync.bin"),
    "writeFileSync/readFileSync error",
  );
...
// Testing: writeTextFile / readTextFile / remove
{
  ...
  assertEquals(
    text,
    await Bueno.fs.readTextFile("async.txt"),
    "writeTextFile/readTextFile error",
  );
...
// Testing: writeTextFileSync / readTextFileSync / removeSync
{
  ...
  assertEquals(
    text,
    Bueno.fs.readTextFileSync("sync.txt"),
    "writeTextFileSync/readTextFileSync error",
  );
